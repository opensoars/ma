  ...
  sections.forEach(function (section){
    ...
    section.subs.forEach(function (sub){
      ...
      switch(sub.indentation){
        case 2: content_to_write.push('### ' + section.header);    break;
        case 4: content_to_write.push('#### ' + section.header);   break;
        case 6: content_to_write.push('##### ' + section.header);  break;
        case 8: content_to_write.push('###### ' + section.header); break;
      }
