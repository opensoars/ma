...
function processFile(err, data){
  ...
  var has_table_comment_open = data.test('<!--- TABLE_OF_CONTENTS -->'),
      has_table_comment_close = data.test('<!--- /TABLE_OF_CONTENTS -->');

  console.log(has_table_comment_open, has_table_comment_close);
