...
function processFile(fn, data){
  ...
  // The spacing used to indent lists, not really the character used to
  //  start a list with
  // So when looping, we can loop till we find another indentation level
  // that matches the previous match:
  // * asd (Sets previous indentation were checking for to 0)
  // * dsa
  //   - zzz 
  //   - aaa
  // * olk (this one is matching the indentation were checking: 0)

  // We could use another helper function istead of inline 
  // anonymous function
