 ...
 */
module.exports = function processFile(fn, file_data){
  ...
  // Write to test file
  var test_file_name = 'test_result.md';

  fs.writeFile(test_file_name, file_data, function (err){
    if(err) return logErr('Could not write ' + test_file_name, err);
    log('Wrote ' + test_file_name)
  });
